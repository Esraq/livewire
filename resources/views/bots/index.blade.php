...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Board of Trustees</h1>
    ...
    <div class="card mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Board Members</h6>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-items-center mb-0">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button type="button"
                                    ...
                                    data-action="{{ route('bots.update', $bot) }}"
                                    data-id="{{ $bot->id }}"
                                    data-weight="{{ $bot->weight }}"
                                    data-name="{{ $bot->name }}"
                                    data-position="{{ $bot->position }}"
                                    data-image="{{ $bot->image_url }}">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center text-muted py-4">No board members found.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
...
$(function () {
    ...
    var storeUrl  = "{{ route('bots.store') }}";
    var updateUrl = "{{ route('bots.update', '__ID__') }}";
